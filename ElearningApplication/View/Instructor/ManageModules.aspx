<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageModules.aspx.cs"
    Inherits="ElearningApplication.View.Instructor.ManageModules" %>
        ...
        <form id="form1" runat="server">
            <div class="container">
                ...
                <asp:SqlDataSource ID="sqlModules" runat="server"
                    ConnectionString="<%$ ConnectionStrings:ElearningDb %>"
                    DeleteCommand="DELETE FROM [LessonProgress] WHERE [LessonId] IN (SELECT [LessonId] FROM [Lessons] WHERE [ModuleId] = @ModuleId); DELETE FROM [Lessons] WHERE [ModuleId] = @ModuleId; DELETE FROM [Modules] WHERE [ModuleId] = @ModuleId"
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td>Description:</td>
                        <td>
                            <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" Rows="3" Width="300px">
                            </asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <asp:Button ID="btnAdd" runat="server" Text="Add Module" CssClass="btn btn-add"
