<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageLessons.aspx.cs"
    Inherits="ElearningApplication.View.Instructor.ManageLessons" %>
        ...
        <form id="form1" runat="server">
            <div class="container">
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="ddlCourses" runat="server" AutoPostBack="True" DataSourceID="sqlCourses"
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="ddlModules" runat="server" AutoPostBack="True" DataSourceID="sqlModules"
                        DataTextField="Title" DataValueField="ModuleId">
                    </asp:DropDownList>
                ...
                <asp:GridView ID="gvLessons" runat="server" AutoGenerateColumns="False" DataKeyNames="LessonId"
                    DataSourceID="sqlLessons" CssClass="grid-view" EmptyDataText="No lessons found in this module."
                    OnSelectedIndexChanged="gvLessons_SelectedIndexChanged">
                    <Columns>
                ...
                <asp:SqlDataSource ID="sqlLessons" runat="server"
                    ConnectionString="<%$ ConnectionStrings:ElearningDb %>"
                    DeleteCommand="DELETE FROM [LessonProgress] WHERE [LessonId] = @LessonId; DELETE FROM [Lessons] WHERE [LessonId] = @LessonId"
                    ...
                    <InsertParameters>
                        <asp:ControlParameter ControlID="ddlModules" Name="ModuleId" PropertyName="SelectedValue"
                            Type="Int32" />
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td>Content:</td>
                        <td>
                            <asp:TextBox ID="txtContent" runat="server" TextMode="MultiLine" Rows="5" Width="300px">
                            </asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>Video URL:</td>
                        <td>
                            <asp:TextBox ID="txtVideoUrl" runat="server" Width="300px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>Duration (min):</td>
                        <td>
                            <asp:TextBox ID="txtDuration" runat="server" Width="50px" Text="0"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>Order:</td>
                        <td>
                            <asp:TextBox ID="txtOrder" runat="server" Width="50px" Text="1"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>
                            <asp:Button ID="btnAdd" runat="server" Text="Add Lesson" CssClass="btn btn-add"
